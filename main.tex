...
Add a command like SQL-groupby to complete the mini-language:
\begin{itemize}
...
\end{verbatim}}
\vspace{-0.5\baselineskip}
Physicists already do this manually, by repeatedly looping over the same ntuple (myself included).

Expressed this way, it's classic map-reduce, which covers a wide variety of use-cases.
\end{block}
\end{frame}
