...
\begin{frame}[fragile]{Examples}
\begin{block}{Partitioning by one feature and plotting another (map-reduce)}
\vspace{-0.5\baselineskip}
{\scriptsize \begin{verbatim}
print Data.source().map(lambda _: (_.fType, _.fTemperature)).groupByKey()
{"type0": [20.756078720092773, 20.60653305053711, 20.34678840637207, ...
 "type1": [20.01813507080078, 20.524988174438477, 20.92605972290039, ...
 ...
\end{verbatim}}

This kind of command should make many histograms, one for each key ({\tt fType} in this example).
