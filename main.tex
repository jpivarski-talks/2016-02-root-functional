...
\end{verbatim}}
\vspace{-0.5\baselineskip}
Physicists already do this manually, by repeatedly looping over the same ntuple (myself included). Expressed this way, it's classic map-reduce, which is more efficient than repeating the loop and covers a wide variety of use-cases.
\end{block}
\end{frame}
