...
\textcolor{white}{Note:} {\tt flatMapGet} maps a {\tt get} operation across subcollections, keeping only those for which {\tt 2} exists. Perhaps a better solution than {\tt filterMap}, though less general.
\end{block}
\end{frame}
